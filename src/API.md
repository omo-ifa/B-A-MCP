  ...
  "properties": {
    ...
    "stats": {
      ...
      "properties": {
        ...
        "genuine_abandoned_count": { "type": "number", "description": "orphans scored as rot — unreachable candidates that are NOT a detected accepted-layout class (route-to-directory-nested, skill-discovery, agent-runtime config, tight dated/versioned-archival). The orphans sub-score is 1 − genuine_abandoned_count / (its n); orphan_count stays the count of every orphan finding, so genuine_abandoned_count ≤ orphan_count." },
